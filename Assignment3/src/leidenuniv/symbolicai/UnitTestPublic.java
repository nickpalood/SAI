...
public class UnitTestPublic {
	...
	static boolean doTest(String testnr) {
		switch(testnr) {
			...
			case "4e":
				System.out.print("Test 4e (optional): findAllSubst correctly finds 2 subst for !male(Y)&parent(X,Y)>daughter(Y)");
			...
			case "4g":
				System.out.print("Test 4g (optional): findAllSubst correctly finds 2 subst for !=(X,Y)&parent(Z,X)&parent(Z,Y)>sibling(X,Y)");
